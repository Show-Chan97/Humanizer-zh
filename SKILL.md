---
name: humanizer-zh-v2
version: 2.5.1
description: |
  去除文本中的 AI 生成痕迹，使文字听起来更自然、更像人类书写。
  适用于编辑或审阅文本。当用户提到"去 AI 味"、"人性化"、"更像人话"、
  "听起来不像 AI"、或者需要将 AI 生成的文本改写得更自然时触发。
  基于 Wikipedia "Signs of AI writing" 指南 v2.5.1，检测并修复 29 种 AI 模式。
...
**问题：** LLM 经常隐藏行为主体，或者用"No configuration file needed"或"Results are preserved automatically"这样的无主语片段。主动语态更清晰时，应改写为被动。
...
**问题：** 标题后跟着一个段落，仅仅简单重复标题内容，然后才开始真正的内容。这种引导句通常毫无意义，使文章感觉被padding了。
...
- 提到的人名和研究引用可能读起来像合理但捏造的占位符，除非是真实的和有来源的。
